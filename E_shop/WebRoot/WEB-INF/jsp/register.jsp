		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="<%=path %>/user_register.action" method="post" novalidate="novalidate" onsubmit="return checkFrom();">
						<table>
							<tbody><tr>
								<th>
									...
									<td>
										<span class="fieldSet">
											<div style="float: left;">
												...
												<img id="securityimg" class="securitygimg" 
												src="./securityCode.action" onclick="change()" title="点击更换验证码">
											</div>
											<strong style="color:red;size:2px;"><s:actionmessage /></strong>
										</span>
									</td>
								</tr>
							<tr>
