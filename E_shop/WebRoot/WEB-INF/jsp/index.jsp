		...
		<div class="span5">
			<div class="logo">
				<a href="./index.action"> <img
					src="./image/r___________renleipic_01/logo.gif" alt="传智播客" />
				</a>
			</div>
		</div>
		<div class="span9">
		...
		<div class="span24">
			...
			<img src="./image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					...
					<li><a href="./product_findByPid.action?cid=<s:property value="#p.categoryThree.categorySecond.category.cid" />&pid=<s:property value="#p.pid" />" target="_blank"><img src="./<s:property value="#p.image" />"
